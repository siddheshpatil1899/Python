...
app = FastAPI(
    ...
    version="1.0.0",
    description="FinOps AI backend for cost visibility, waste detection, anomaly detection, forecasting, chatbot, and warehouse reporting.",
)
...
# Legacy routes kept temporarily so your old tested URLs continue working.
